            ...
            switch (_b.label) {
              ...
              case 1:
                ...
                Array.from(operations).forEach(function (operation) {
                  if (operation.getAttribute('name') === 'Transaction') _this._hasTransaction = true;else if (operation.getAttribute('name') === 'LockFeature') _this._hasLockFeature = true;
                });
      ...
      Wfst.prototype._addControlTools = function () {
        ...
        var createSubControl = function createSubControl() {
          var createSelectDrawElement = function createSelectDrawElement() {
            ...
            var types = [GeometryType_1.default.POINT, GeometryType_1.default.MULTI_POINT, GeometryType_1.default.LINE_STRING, GeometryType_1.default.MULTI_LINE_STRING, GeometryType_1.default.POLYGON, GeometryType_1.default.MULTI_POLYGON, GeometryType_1.default.CIRCLE];
      ...
      Wfst.prototype.activateDrawMode = function (layerName, geomDrawTypeSelected) {
        ...
        var getDrawTypeSelected = function getDrawTypeSelected(layerName) {
          ...
          if (_this._selectDraw) {
            var geomLayer = _this._geoServerData[layerName].geomType; // If a draw Type value is provided, the function was triggerd
