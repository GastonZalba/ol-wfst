...
var Wfst = /** @class */ (function () {
    ...
    Wfst.prototype.resetStateButtons = function () {
    ...
    Wfst.prototype.addToolsControl = function () {
        ...
        var createLayerElement = function (layerName) {
            return "\n                <div>       \n                    <label for=\"wfst--" + layerName + "\">\n                        <input value=\"" + layerName + "\" id=\"wfst--" + layerName + "\" type=\"radio\" class=\"ol-wfst--tools-control-input\" name=\"wfst--select-layer\" " + ((layerName === _this._insertNewLayer) ? 'checked="checked"' : '') + ">\n                        " + layerName + "\n                    </label>\n                </div>\n            ";
        };
        var controlDiv = document.createElement('div');
        ...
        if (Object.keys(this._layers).length > 1) {
            ...
            radioInputs.forEach(function (radioInput) {
                radioInput.onchange = function () {
                    _this._insertNewLayer = radioInput.value;
                    _this.resetStateButtons();
                    _this.activateDrawMode(_this._insertNewLayer);
                };
            });
