...
import Control$1 from 'ol/control/Control';
...
import { MultiPolygon, MultiLineString, MultiPoint, GeometryCollection, Polygon } from 'ol/geom';
import { WFS, GeoJSON as GeoJSON$1, KML } from 'ol/format';
import { Control } from 'ol/control';
import { Style, Stroke, Fill, Circle } from 'ol/style';
import BaseObject from 'ol/Object';
import Circle$1 from 'ol/geom/Circle';
import GeometryCollection$1 from 'ol/geom/GeometryCollection';
import Feature from 'ol/Feature';
import KML$1 from 'ol/format/KML';
import WFS$1 from 'ol/format/WFS';
...
class Geoserver extends BaseObject {
    ...
    constructor(options) {
        ...
        // Formats
        this._formatWFS = new WFS$1();
        this._formatGeoJSON = new GeoJSON();
        this._formatKml = new KML$1({
            extractStyles: false,
            showPointNames: false
        });
        this._xs = new XMLSerializer();
