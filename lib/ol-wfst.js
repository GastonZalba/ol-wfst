                ...
                switch (_a.label) {
                    case 0:
                        getLayerData = function (layerName) { return __awaiter(_this, void 0, void 0, function () {
                            var params, url_fetch, response, data, err_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        params = new URLSearchParams({
        ...
        var newWfsLayer = function (layerName) {
            var source = new source_1.Vector({
                ...
                loader: function (extent) { return __awaiter(_this, void 0, void 0, function () {
                    var params, url_fetch, response, data, features, err_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                params = new URLSearchParams({
            ...
            return __generator(this, function (_a) {
                ...
                features.forEach(function (feature) {
                    ...
                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        var options, transaction, payload, response, parseResponse, responseStr, findError, err_4;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                    ...
                    switch (_c.label) {
                        case 0:
                            _loop_1 = function (layerName) {
                                var layer, coordinate, buffer, url, response, data, features, err_5;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
