...
var Wfst = /** @class */ (function () {
    function Wfst(map, opt_options) {
        ...
        this.updateFeatures = [];
        this.deleteFeatures = [];
        this.formatWFS = new format_1.WFS();
        this.formatGeoJSON = new format_2.GeoJSON();
    ...
    Wfst.prototype.createEditLayer = function () {
        this.editLayer = new layer_1.Vector({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                cloneFeature = function (feature) {
                    delete _this._editedFeatures[feature.getId()];
                ...
                this.countRequests++;
                numberRequest = this.countRequests;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                transaction = this.formatWFS.writeTransaction(this.insertFeatures, this.updateFeatures, this.deleteFeatures, options);
                                payload = this.xs.serializeToString(transaction);
                                // Fixes geometry name
                            ...
                            case 2:
                                response = _a.sent();
                                parseResponse = this.formatWFS.readTransactionResponse(response);
    ...
    Wfst.prototype.addLayerModeInteractions = function () {
            ...
            _this.interactionWfsSelect.on('select', function (_a) {
                ...
                if (selected.length) {
                    selected.forEach(function (feature) {
                        if (!_this._editedFeatures[feature.getId()]) {
        ...
        var addWmsInteraction = function () {
                            ...
                            _loop_1 = function (layerName) {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 3:
                                            data = _a.sent();
                                            features = this_1.formatGeoJSON.readFeatures(data);
                                            if (!features.length)
            ...
            _this.keyClickWms = _this.map.on(_this.evtType, function (evt) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    Wfst.prototype.addDrawInteraction = function (layerName) {
        ...
        var drawHandler = function () {
            _this.interactionDraw.on('drawend', function (evt) {
                Observable_1.unByKey(_this.keyRemove);
    ...
    Wfst.prototype.selectFeatureHandler = function () {
        ...
        this.keySelect = this.interactionSelect.getFeatures().on('remove', function (evt) {
            ...
            if (_this.isFeatureEdited(feature)) {
                ...
                _this.editLayer.getSource().removeFeature(feature);
    ...
    Wfst.prototype.removeFeatureHandler = function () {
        ...
        this.keyRemove = this.editLayer.getSource().on('removefeature', function (evt) {
            Observable_1.unByKey(_this.keySelect);
            var feature = evt.feature;
    ...
    Wfst.prototype.deleteElement = function (feature) {
        ...
        features.forEach(function (feature) { return _this.editLayer.getSource().removeFeature(feature); });
        ...
        this.modal.on('dismiss', function (modal, event) {
            if (event.target.dataset.action === 'save') {
                ...
                inputs.forEach(function (el) {
                    var value = el.value;
                    var field = el.name;
                    _this.editFeature.set(field, value, /*isSilent = */ true);
                });
                _this.editFeature.changed();
                _this.addFeatureToEditedList(_this.editFeature);
                _this.transactWFS('update', _this.editFeature);
            }
            else if (event.target.dataset.action === 'delete') {
                _this.map.removeOverlay(_this.map.getOverlayById(feature.getId()));
                _this.deleteElement(_this.editFeature);
            }
        });
    };
    return Wfst;
