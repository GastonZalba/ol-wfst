...
var Wfst = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                cloneFeature = function (feature) {
                    _this.removeFeatureFromEditList(feature);
                ...
                setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                    var layerName, options, transaction, payload, response, parseResponse, responseStr, findError, err_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                if (selected.length) {
                    selected.forEach(function (feature) {
                        if (!_this._editedFeatures.has(String(feature.getId()))) {
                            ...
                            _this.addFeatureToEdit(feature, coordinate);
                        }
                    });
                }
            });
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 3:
                                            ...
                                            features.forEach(function (feature) { return _this.addFeatureToEdit(feature, coordinate, layerName); });
                                            return [3 /*break*/, 5];
                                        case 4:
                                            err_4 = _a.sent();
                                            console.error(err_4);
    ...
    Wfst.prototype.removeFeatureFromEditList = function (feature) {
    ...
    Wfst.prototype.addInteractions = function () {
        ...
        this.interactionSelectModify = new interaction_1.Select({
            ...
            removeCondition: function (evt) { return (_this.editMode === 'button' && _this._isEditMode) ? true : false; }
        });
        ...
        this.interactionModify = new interaction_1.Modify({
            ...
            condition: function (evt) {
                return condition_1.primaryAction(evt) && _this._isEditMode;
            }
        });
    ...
    Wfst.prototype.cancelEditFeature = function (feature) {
        this.removeOverlayHelper(feature);
        if (this.editMode === 'button') {
            this.editModeOff();
        }
    };
    Wfst.prototype.finishEditFeature = function (feature) {
        var _this = this;
    ...
    Wfst.prototype.selectFeatureHandler = function () {
        ...
        this._keySelect = this.interactionSelectModify.getFeatures().on('remove', function (evt) {
            ...
            _this.cancelEditFeature(feature);
            _this.finishEditFeature(feature);
        });
    };
    ...
    Wfst.prototype.editModeOn = function (feature) {
        var _this = this;
        ...
        cancelButton.onclick = function () {
            feature.setGeometry(_this._editFeaturOriginal.getGeometry());
            _this.removeFeatureFromEditList(feature);
            _this.interactionSelectModify.getFeatures().remove(feature);
        };
        ...
        this._controlChanges = new Control_1.default({
            element: controlDiv
        });
        this.map.addControl(this._controlChanges);
    };
    Wfst.prototype.editModeOff = function () {
        this._isEditMode = false;
    ...
    Wfst.prototype.addFeatureToEdit = function (feature, coordinate, layerName) {
        var _this = this;
    ...
    Wfst.prototype.addToolsControl = function () {
        var _this = this;
        var resetStateButtons = function () {
        ...
        drawButton.onclick = function () {
            ...
            _this.activateDrawMode(_this._insertNewLayer);
        };
        this._controlTools = new Control_1.default({
            element: controlDiv
        });
        controlDiv.append(selectionButton);
        controlDiv.append(drawButton);
        if (Object.keys(this._layers).length > 1) {
            var drawSelect_1 = document.createElement('select');
            drawSelect_1.innerHTML = Object.keys(this._layers).map(function (key) { return "<option value=\"" + key + "\" " + ((key === _this._insertNewLayer) ? 'selected="selected"' : '') + ">" + key + "</option>"; }).join();
            drawSelect_1.className = 'ol-wfst--tools-control-select';
            drawSelect_1.onchange = function () {
                _this._insertNewLayer = drawSelect_1.value;
                _this.activateDrawMode(_this._insertNewLayer);
            };
            controlDiv.append(drawSelect_1);
        }
    ...
    Wfst.prototype.initModal = function (feature) {
        ...
        this.modal.on('dismiss', function (modal, event) {
            if (event.target.dataset.action === 'save') {
                ...
                _this.removeOverlayHelper(feature);
                _this.deleteElement(_this._editFeature);
            }
        });
    };
    Wfst.prototype.removeOverlayHelper = function (feature) {
