...
var Wfst = /** @class */ (function () {
    function Wfst(map, opt_options) {
        ...
        // Assign user options
        this.options = __assign(__assign({}, this.options), opt_options);
        // LANGUAGE SUPPORT
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this._connectToGeoServer()];
                    case 1:
                        _a.sent();
                        if (!this.options.layers) return [3 /*break*/, 3];
                        return [4 /*yield*/, this._getLayersData(this.options.layers, this.options.geoServerUrl)];
                    case 2:
                        _a.sent();
    ...
    Wfst.prototype._lockFeature = function (featureId, layerName, retry) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var params, url_fetch, response, data, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = new URLSearchParams({
     ...
     * @private
     */
    Wfst.prototype._getLayersData = function (layers, geoServerUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var getLayerData, _i, layers_1, layer, layerName, layerLabel, data, targetNamespace, properties, geom, err_4;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < layers_1.length)) return [3 /*break*/, 6];
                        layer = layers_1[_i];
                    ...
                    case 3:
                        ...
                        if (data) {
                            ...
                            geom = properties.find(function (el) { return el.type.indexOf('gml:') >= 0; });
    ...
    Wfst.prototype._createLayers = function (layers) {
        ...
        var newWfsLayer = function (layerParams) {
            var layerName = layerParams.name;
            var cqlFilter = layerParams.cql_filter;
    ...
    Wfst.prototype._transactWFS = function (mode, features, layerName) {
        return __awaiter(this, void 0, void 0, function () {
            var cloneFeature, refreshWmsLayer, refreshWfsLayer, clonedFeatures, _i, features_1, feature, clone, numberRequest;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                if (!clonedFeatures.length) {
                    return [2 /*return*/, this._showError(this._i18n.errors.noValidGeometry)];
                }
                switch (mode) {
                    case 'insert':
                ...
                setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                    var options, transaction, payload, response, parseResponse, responseStr, findError, err_6;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                _a.trys.push([1, 5, , 6]);
                                return [4 /*yield*/, fetch(this.options.geoServerUrl, {
                                        method: 'POST',
                                        body: payload,
                                        headers: {
                            ...
                            case 4:
                                if (mode !== 'delete')
                                    this._editLayer.getSource().removeFeature(features[0]);
    ...
    Wfst.prototype._addInteractions = function () {
        ...
        var prepareWmsInteraction = function () {
                    ...
                    switch (_c.label) {
                        case 0:
                            _loop_1 = function (layerName) {
                                var layer, coordinate, buffer, url, response, data, features, err_7;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 4:
                                            err_7 = _a.sent();
                                            this_1._showError(err_7.message);
                                            return [3 /*break*/, 5];
                                        case 5: return [2 /*return*/];
                                    }
                                });
            ...
            _this._keyClickWms = _this.map.on(_this.options.evtType, function (evt) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    Wfst.prototype._addHandlers = function () {
        ...
        this.map.on('moveend', function () {
            ...
            if (_this._currentZoom !== _this._lastZoom)
                handleZoomEnd();
    ...
    Wfst.prototype._addControl = function () {
    };
    /**
     *
     * @param feature
    ...
    */
    ...
    Wfst.prototype._processUploadFile = function (evt) {
        return __awaiter(this, void 0, void 0, function () {
            var fileReader, fixGeometry, checkGeometry, file, features, extension, string, err_8, invalidFeaturesCount, validFeaturesCount, featuresToInsert, _i, features_2, feature, content;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        checkGeometry = function (feature) {
                            // Geometry of the layer
                            var geomType = _this._geoServerData[_this._layerToInsertElements].geomType;
                            var geomTypeFeature = feature.getGeometry().getType();
    ...
    Wfst.prototype._addControlTools = function () {
        ...
        var createUpload = function () {
            ...
            uploadInput.onchange = function (evt) { return _this._processUploadFile(evt); };
            container.append(uploadInput);
            container.append(uploadButton);
            return container;
        };
        var createLayerElement = function (layerParams) {
            var layerName = layerParams.name;
        ...
        var html = Object.keys(this._mapLayers).map(function (key) { return createLayerElement(_this.options.layers.find(function (el) { return el.name === key; })); });
    ...
    Wfst.prototype._initEditFieldsModal = function (feature) {
        ...
        content += '</form>';
        var footer = "<button type=\"button\" class=\"btn btn-link btn-third\" data-action=\"delete\" data-dismiss=\"modal\">" + this._i18n.labels.delete + "</button>\n                        <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\"> " + this._i18n.labels.cancel + "</button>\n                        <button type=\"button\" class=\"btn btn-primary\" data-action=\"save\" data-dismiss=\"modal\"> " + this._i18n.labels.save + "</button>\n                        ";
        this.modal = new modal_vanilla_1.default({
            header: true,
            headerClose: true,
