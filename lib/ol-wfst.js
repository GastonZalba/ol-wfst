...
var Wfst = /** @class */ (function () {
     ...
     * @private
     */
    Wfst.prototype._initAsyncOperations = function (layers, showControl, active) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._getLayersData(layers, this.options.geoServerUrl)];
                    case 2:
                        _a.sent();
    ...
    Wfst.prototype._getLayersData = function (layers, geoServerUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var getLayerData, _i, layers_1, layerName, data, targetNamespace, properties, geom, err_4;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Wfst.prototype._addControlTools = function () {
        ...
        var html = Object.keys(this._mapLayers).map(function (key) { return createLayerElement(key); });
