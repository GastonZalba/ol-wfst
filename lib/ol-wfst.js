...
var Wfst = /** @class */ (function () {
    function Wfst(map, opt_options) {
        ...
        this.options = {
            ...
            minZoom: 9,
            geoServerUrl: null,
            beforeInsertFeature: function (feature) { return feature; },
            processUpload: null,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                features.forEach(function (feature) {
                    ...
                    // Filters
                    if (mode === 'insert') {
                        clone = _this.options.beforeInsertFeature(clone);
                    }
    ...
    Wfst.prototype._deleteElement = function (feature, confirm) {
        ...
        if (confirm) {
            var confirmModal = modal_vanilla_1.default.confirm('¿Está seguro de borrar el elemento?', {
                animateInClass: 'in'
            });
    ...
    Wfst.prototype._addControlTools = function () {
        ...
        var createUpload = function () {
            ...
            uploadInput.onchange = function (evt) { return __awaiter(_this, void 0, void 0, function () {
                var file, features, extension, string, err_8;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
