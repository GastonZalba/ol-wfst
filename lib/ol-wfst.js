...
var Wfst = /** @class */ (function () {
    ...
    Wfst.prototype._prepareLayers = function (layers) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, operations, _i, _b, operation;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this._getServerCapabilities()];
                    case 1:
                        _a.capabilities = _c.sent();
                        console.log(this.capabilities);
                        operations = this.capabilities.getElementsByTagName("ows:Operation");
    ...
    Wfst.prototype._lockFeature = function (featureId, layerName, retry) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var params, url_fetch, response, data, dataDoc, err_1;
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        try {
                            ...
                            dataDoc = (new window.DOMParser()).parseFromString(data, 'text/xml');
                            console.log(dataDoc);
                        }
     ...
     * @private
     */
    Wfst.prototype._getServerCapabilities = function () {
        return __awaiter(this, void 0, void 0, function () {
        ...
        var newWfsLayer = function (layerName) {
            var source = new source_1.Vector({
                ...
                loader: function (extent) { return __awaiter(_this, void 0, void 0, function () {
                    var params, url_fetch, response, data, features, err_4;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                params = new URLSearchParams({
            ...
            return __generator(this, function (_a) {
                ...
                features.forEach(function (feature) {
                    ...
                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        var options, transaction, payload, response, parseResponse, responseStr, findError, err_5;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
