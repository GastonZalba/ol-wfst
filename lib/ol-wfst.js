(function (factory) {
    ...
    var TileState_1 = __importDefault(require("ol/TileState")); // External
                ...
                return __generator(this, function (_b) {
                  switch (_b.label) {
                    case 0:
                      ...
                      srs = this.view.getProjection().getCode(); // Force latitude/longitude order
                      ...
                      if (this._geoServerData[layerName].geomType === 'GeometryCollection') {
                        if (mode === 'insert') {
                          ...
                          properties = dataDoc.getElementsByTagName('Property'); // for (let property of properties) {
