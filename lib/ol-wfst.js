...
var Wfst = /** @class */ (function () {
        ...
        var newWfsLayer = function (layerParams) {
            ...
            var source = new source_1.Vector({
                ...
                loader: function (extent) { return __awaiter(_this, void 0, void 0, function () {
                    var isVisible, params, url_fetch, response, data, features, err_5;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                isVisible = this.view.getZoom() > this.options.minZoom;
                                params = new URLSearchParams({
                                    service: 'wfs',
                                    version: '1.0.0',
                                    request: 'GetFeature',
    ...
    Wfst.prototype._transactWFS = function (mode, features, layerName) {
        return __awaiter(this, void 0, void 0, function () {
            var fixGeometry, checkGeometry, cloneFeature, refreshWmsLayer, refreshWfsLayer, clonedFeatures, _i, features_1, feature, clone, numberRequest;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    Wfst.prototype._addControlTools = function () {
        ...
        var createUpload = function () {
            ...
            uploadInput.onchange = function (evt) { return __awaiter(_this, void 0, void 0, function () {
                var file, features, extension, string, projection, err_8;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!this.options.processUpload) return [3 /*break*/, 1];
                        ...
                        case 2:
                            string = _a.sent(), projection = void 0;
