        ...
        var newWmsLayer = function (layerParams) {
            ...
            var layer = new layer_1.Tile({
                source: new source_1.TileWMS({
                    ...
                    tileLoadFunction: function (tile, src) { return __awaiter(_this, void 0, void 0, function () {
                        var headers, response, data, err_5;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    headers = __assign({ 'Access-Control-Allow-Origin': '*' }, this.options.headers);
                                    _a.label = 1;
                                case 1:
                                    _a.trys.push([1, 4, , 5]);
        ...
        var newWfsLayer = function (layerParams) {
            ...
            var source = new source_1.Vector({
                ...
                loader: function (extent) { return __awaiter(_this, void 0, void 0, function () {
                    var params, url_fetch, response, data, features, err_6;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                params = new URLSearchParams({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                    var options, transaction, payload, headers, response, parseResponse, responseStr, findError, _i, _a, feature, err_7;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _b.trys.push([1, 5, , 6]);
                                headers = __assign({ 'Content-Type': 'text/xml', 'Access-Control-Allow-Origin': '*' }, this.options.headers);
                    ...
                    switch (_c.label) {
                        case 0:
                            _loop_1 = function (layerName) {
                                var layer, coordinate, buffer, url, response, data, features, err_8;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 4:
                                            err_8 = _a.sent();
                                            this_1._showError(err_8.message);
                                            return [3 /*break*/, 5];
                                        case 5: return [2 /*return*/];
                                    }
                                });
