...
var Wfst = /** @class */ (function () {
    function Wfst(map, opt_options) {
        ...
        this.beforeInsertFeature = function (feature) { return ('beforeInsertFeature' in opt_options) ? opt_options.beforeInsertFeature(feature) : feature; };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._getLayersData(layers, this._geoServerUrl)];
                    case 2:
                        _a.sent();
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        url_fetch = this._geoServerUrl + '?' + params.toString();
                                        _a.label = 1;
                                    case 1:
                                        _a.trys.push([1, 4, , 5]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                features.forEach(function (feature) {
                    ...
                    // Filters
                    if (mode === 'insert') {
                        clone = _this.beforeInsertFeature(clone);
                    }
                    ...
                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 5, , 6]);
                                    return [4 /*yield*/, fetch(this._geoServerUrl, {
                                            method: 'POST',
                                            body: payload,
                                            headers: {
    ...
    Wfst.prototype._addHandlers = function () {
        ...
        var handleZoomEnd = function () {
            if (_this._currentZoom < _this._minZoom) {
                // Hide the layer
                if (_this._isVisible) {
